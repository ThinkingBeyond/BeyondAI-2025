...
Financial markets react instantly to news. Analysts, traders, and machine learning engineers all attempt to model how headlines influence next-day stock prices. While many studies use pretrained models like FinBERT, our project asks a more fundamental question:
...
- Collected price data for the 10 most frequent tickers: `MRK, MS, MU, NVDA, QQQ, M, EBAY, NFLX, GILD, VZ`
...
- Full price collection using **yfinance**
...
### LSTM With Attention (Scratch-Built)
...
- Both models perform better than random guessing (50% accuracy, 0.0 F1), but results are inconclusive
...
- Overall, the results show a slight but consistent edge for the LSTM
...
- Apply time-series models, e.g., LSTM-Attention hybrids
- Use more robust prediction targets:
  - Multi-day movement
  - Shorter time windows (e.g., 5 min after the headline rather than the next day)
...
- Zeng, Qingyun & Jiang, Tingsong (2025). *Financial Sentiment Analysis Using FinBERT with Application in Predicting Stock Movement*. arXiv:2306.02136v3.
- Vaswani, A. et al. (2017). *Attention Is All You Need*. arXiv:1706.03762.
- Kaggle — Massive Stock News Database: [link](https://www.kaggle.com/datasets/miguelaenlle/massive-stock-news-analysis-db-for-nlpbacktests)
